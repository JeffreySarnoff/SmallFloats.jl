window.MULTIDOCUMENTER\_ROOT\_PATH = '/'window.dataLayer = window.dataLayer || \[\]; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-Q3FE4BYYHQ'); SciML Style Guide for Julia · SciML Style Guide for JuliadocumenterBaseURL="."

[![home](../../assets/logo.png)](https://sciml.ai)
...
[ModelingToolkit](../../ModelingToolkit/)[Catalyst](../../Catalyst/)[NBodySimulator](../../NBodySimulator/)[ParameterizedFunctions](../../ParameterizedFunctions/)

Model Libraries and Importers

[ModelingToolkitStandardLibrary](../../ModelingToolkitStandardLibrary/)[ModelingToolkitNeuralNets](../../ModelingToolkitNeuralNets/)[DiffEqCallbacks](../../DiffEqCallbacks/)[FiniteStateProjection](../../FiniteStateProjection/)[CellMLToolkit](../../CellMLToolkit/)[SBMLToolkit](../../SBMLToolkit/)[BaseModelica](../../BaseModelica/)[ReactionNetworkImporters](../../ReactionNetworkImporters/)

Symbolic Tools

[ModelOrderReduction](../../ModelOrderReduction/)[Symbolics](../../Symbolics/)[SymbolicUtils](../../SymbolicUtils/)[SymbolicIntegration](../../SymbolicIntegration/)[SymbolicSMT](../../SymbolicSMT/)[SymbolicLimits](../../SymbolicLimits/)[SymbolicAnalysis](../../SymbolicAnalysis/)

Array Libraries

[RecursiveArrayTools](../../RecursiveArrayTools/)[ComponentArrays](../../ComponentArrays/)[LabelledArrays](../../LabelledArrays/)[MultiScaleArrays](../../MultiScaleArrays/)

Solvers

Equation Solvers

[LinearSolve](../../LinearSolve/)[NonlinearSolve](../../NonlinearSolve/)[DifferentialEquations](../../DiffEqDocs/)[Integrals](../../Integrals/)[DifferenceEquations](../../DifferenceEquations/)[Optimization](../../Optimization/)[JumpProcesses](../../JumpProcesses/)[LineSearch](../../LineSearch/)

Inverse Problems / Estimation

[CurveFit](../../CurveFit/)[SciMLSensitivity](../../SciMLSensitivity/)[DiffEqParamEstim](../../DiffEqParamEstim/)[DiffEqBayes](../../DiffEqBayes/)

PDE Solvers

[MethodOfLines](../../MethodOfLines/)[NeuralPDE](../../NeuralPDE/)[NeuralOperators](../../NeuralOperators/)[FEniCS](../../FEniCS/)[HighDimPDE](../../HighDimPDE/)[DiffEqOperators](../../DiffEqOperators/)[FiniteVolumeMethod](../../FiniteVolumeMethod/)[FiniteVolumeMethod1D](../../FiniteVolumeMethod1D/)

Advanced Solver APIs

[OrdinaryDiffEq](../../OrdinaryDiffEq/)[BoundaryValueDiffEq](../../BoundaryValueDiffEq/)[DiffEqGPU](../../DiffEqGPU/)

Analysis

Parameter Analysis

[EasyModelAnalysis](../../EasyModelAnalysis/)[GlobalSensitivity](../../GlobalSensitivity/)[StructuralIdentifiability](../../StructuralIdentifiability/)
...
[PolyChaos](../../PolyChaos/)[SciMLExpectations](../../SciMLExpectations/)

Machine Learning

Function Approximation

[Surrogates](../../Surrogates/)[ReservoirComputing](../../ReservoirComputing/)

Implicit Layer Deep Learning

[DiffEqFlux](../../DiffEqFlux/)[DeepEquilibriumNetworks](../../DeepEquilibriumNetworks/)[NeuralLyapunov](../../NeuralLyapunov/)

Symbolic Learning

[DataDrivenDiffEq](../../DataDrivenDiffEq/)[SymbolicNumericIntegration](../../SymbolicNumericIntegration/)

Third-Party Differentiation Tooling

[SparseDiffTools](../../SparseDiffTools/)[FiniteDiff](../../FiniteDiff/)

Developer Tools

Numerical Utilities

[ExponentialUtilities](../../ExponentialUtilities/)[DiffEqNoiseProcess](../../DiffEqNoiseProcess/)[PreallocationTools](../../PreallocationTools/)[EllipsisNotation](../../EllipsisNotation/)[DataInterpolations](../../DataInterpolations/)[DataInterpolationsND](../../DataInterpolationsND/)[PoissonRandom](../../PoissonRandom/)[QuasiMonteCarlo](../../QuasiMonteCarlo/)[RuntimeGeneratedFunctions](../../RuntimeGeneratedFunctions/)[MuladdMacro](../../MuladdMacro/)[FindFirstFunctions](../../FindFirstFunctions/)[SparseDiffTools](../../SparseDiffTools/)[BipartiteGraphs](../../BipartiteGraphs/)

High-Level Interfaces

[SciMLBase](../../SciMLBase/)[SciMLStructures](../../SciMLStructures/)[SciMLLogging](../../SciMLLogging/)[ADTypes](../../ADTypes/)[SymbolicIndexingInterface](../../SymbolicIndexingInterface/)[TermInterface](../../TermInterface/)[SciMLOperators](../../SciMLOperators/)[SurrogatesBase](../../SurrogatesBase/)[CommonSolve](../../CommonSolve/)

Third-Party Interfaces

[ArrayInterface](../../ArrayInterface/)[StaticArrayInterface](../../StaticArrayInterface/)

Developer Documentation

[SciMLStyle](../)[ColPrac](../../ColPrac/)[DiffEq Developer Documentation](../../DiffEqDevDocs/)

Extra Resources

[SciMLWorkshop](../../SciMLWorkshop/)[Extended SciML Tutorials](../../SciMLTutorialsOutput/)[The SciML Benchmarks](../../SciMLBenchmarksOutput/)[ModelingToolkitCourse](../../ModelingToolkitCourse/)

Commercial Support

Commercial Support

[![JuliaHub logo - contact sales today!](/assets/juliahub-logo.svg)](https://juliahub.com/company/contact-us-sciml-docs)

[JuliaHub offers commercial support for ModelingToolkit and the SciML ecosystem. Contact us today to discuss your needs!](https://juliahub.com/company/contact-us-sciml-docs)

Products built with SciML

*   [Dyad](https://juliahub.com/products/dyad)
*   [Pumas](https://pumas.ai/)
*   [Cedar EDA](https://juliahub.com/products/cedar-eda)
*   [Neuroblox](https://www.neuroblox.org/)
*   [Planting Space](https://planting.space/)

/

![SciML Style Guide for Julia logo](assets/logo.png)
...
[GitHub](https://github.com/SciML/SciMLStyle "View the repository on GitHub")[](https://github.com/SciML/SciMLStyle/blob/main/README.md "View source on GitHub")[](# "Settings")[](javascript:; "Collapse all docstrings")

# [SciML Style Guide for Julia](#SciML-Style-Guide-for-Julia)[](#SciML-Style-Guide-for-Julia "Permalink")
...
The SciML Style Guide is a style guide for the Julia programming language. It is used by the [SciML Open Source Scientific Machine Learning Organization](https://sciml.ai/). It covers proper styles to allow for easily high-quality, readable, robust, safety, and fast code that is easy to maintain for production and deployment.

It is open to discussion with the community. Please file an issue or open a PR to discuss changes to the style guide.

## [Table of Contents](#Table-of-Contents)[](#Table-of-Contents "Permalink")
...
## [Code Style Badge](#Code-Style-Badge)[](#Code-Style-Badge "Permalink")
...
## [Overarching Dogmas of the SciML Style](#Overarching-Dogmas-of-the-SciML-Style)[](#Overarching-Dogmas-of-the-SciML-Style "Permalink")

### [Consistency vs Adherence](#Consistency-vs-Adherence)[](#Consistency-vs-Adherence "Permalink")
...
### [Community Contribution Guidelines](#Community-Contribution-Guidelines)[](#Community-Contribution-Guidelines "Permalink")

For a comprehensive set of community contribution guidelines, refer to [ColPrac](https://github.com/SciML/ColPrac). A relevant point to highlight PRs should do one thing. In the context of style, this means that PRs that update the style of a package's code should not be mixed with fundamental code contributions. This separation makes it easier to ensure that large style improvements are isolated from substantive (and potentially breaking) code changes.

### [Open source contributions are allowed to start small and grow over time](#Open-source-contributions-are-allowed-to-start-small-and-grow-over-time)[](#Open-source-contributions-are-allowed-to-start-small-and-grow-over-time "Permalink")
...
### [Generic code is preferred unless code is known to be specific](#Generic-code-is-preferred-unless-code-is-known-to-be-specific)[](#Generic-code-is-preferred-unless-code-is-known-to-be-specific "Permalink")
...
would not be preferred for two reasons. One is that it assumes `A` uses one-based indexing, which would fail in cases like [OffsetArrays](https://github.com/JuliaArrays/OffsetArrays.jl) and [FFTViews](https://github.com/JuliaArrays/FFTViews.jl). Another issue is that it requires indexing, while not all array types support indexing (for example, [CuArrays](https://github.com/JuliaGPU/CuArrays.jl)). A more generic and compatible implementation of this function would be to use broadcast, for example:
...
### [Internal types should match the types used by users when possible](#Internal-types-should-match-the-types-used-by-users-when-possible)[](#Internal-types-should-match-the-types-used-by-users-when-possible "Permalink")
...
### [Trait definition and adherence to generic interface is preferred when possible](#Trait-definition-and-adherence-to-generic-interface-is-preferred-when-possible)[](#Trait-definition-and-adherence-to-generic-interface-is-preferred-when-possible "Permalink")
...
### [Macros should be limited and only be used for syntactic sugar](#Macros-should-be-limited-and-only-be-used-for-syntactic-sugar)[](#Macros-should-be-limited-and-only-be-used-for-syntactic-sugar "Permalink")
...
and thus using such a macro as the interface is not preferred when possible. However, a macro like [`@muladd`](https://github.com/SciML/MuladdMacro.jl) is trivial to picture on a code (it recursively transforms `a*b + c` to `muladd(a,b,c)` for more [accuracy and efficiency](https://en.wikipedia.org/wiki/Multiply%E2%80%93accumulate_operation)), so using such a macro, for example:
...
### [Subpackaging and interface packages is preferred over conditional modules via Requires.jl](#Subpackaging-and-interface-packages-is-preferred-over-conditional-modules-via-Requires.jl)[](#Subpackaging-and-interface-packages-is-preferred-over-conditional-modules-via-Requires.jl "Permalink")

Requires.jl should be avoided at all costs. If an interface package exists, such as [ChainRulesCore.jl](https://github.com/JuliaDiff/ChainRulesCore.jl) for defining automatic differentiation rules without requiring a dependency on the whole ChainRules.jl system, or [RecipesBase.jl](https://github.com/JuliaPlots/RecipesBase.jl) which allows for defining Plots.jl plot recipes without a dependency on Plots.jl, a direct dependency on these interface packages is preferred.
...
### [Functions should either attempt to be non-allocating and reuse caches, or treat inputs as immutable](#Functions-should-either-attempt-to-be-non-allocating-and-reuse-caches,-or-treat-inputs-as-immutable)[](#Functions-should-either-attempt-to-be-non-allocating-and-reuse-caches,-or-treat-inputs-as-immutable "Permalink")
...
### [Out-Of-Place and Immutability is preferred when sufficient performant](#Out-Of-Place-and-Immutability-is-preferred-when-sufficient-performant)[](#Out-Of-Place-and-Immutability-is-preferred-when-sufficient-performant "Permalink")
...
### [Tests should attempt to cover a wide gamut of input types](#Tests-should-attempt-to-cover-a-wide-gamut-of-input-types)[](#Tests-should-attempt-to-cover-a-wide-gamut-of-input-types "Permalink")
...
### [When in doubt, a submodule should become a subpackage or separate package](#When-in-doubt,-a-submodule-should-become-a-subpackage-or-separate-package)[](#When-in-doubt,-a-submodule-should-become-a-subpackage-or-separate-package "Permalink")
...
### [Globals should be avoided whenever possible](#Globals-should-be-avoided-whenever-possible)[](#Globals-should-be-avoided-whenever-possible "Permalink")
...
### [Type-stable and Type-grounded code is preferred wherever possible](#Type-stable-and-Type-grounded-code-is-preferred-wherever-possible)[](#Type-stable-and-Type-grounded-code-is-preferred-wherever-possible "Permalink")
...
### [Numerical functionality should use the appropriate generic numerical interfaces](#Numerical-functionality-should-use-the-appropriate-generic-numerical-interfaces)[](#Numerical-functionality-should-use-the-appropriate-generic-numerical-interfaces "Permalink")
...
### [Functions should capture one underlying principle](#Functions-should-capture-one-underlying-principle)[](#Functions-should-capture-one-underlying-principle "Permalink")
...
### [Internal choices should be exposed as options whenever possible](#Internal-choices-should-be-exposed-as-options-whenever-possible)[](#Internal-choices-should-be-exposed-as-options-whenever-possible "Permalink")
...
### [Prefer code reuse over rewrites whenever possible](#Prefer-code-reuse-over-rewrites-whenever-possible)[](#Prefer-code-reuse-over-rewrites-whenever-possible "Permalink")
...
### [Prefer to not shadow functions](#Prefer-to-not-shadow-functions)[](#Prefer-to-not-shadow-functions "Permalink")
...
### [Avoid unmaintained dependencies](#Avoid-unmaintained-dependencies)[](#Avoid-unmaintained-dependencies "Permalink")
...
### [Avoid unsafe operations](#Avoid-unsafe-operations)[](#Avoid-unsafe-operations "Permalink")
...
### [Avoid non public operations in Julia Base and packages](#Avoid-non-public-operations-in-Julia-Base-and-packages)[](#Avoid-non-public-operations-in-Julia-Base-and-packages "Permalink")
...
### [Always default to constructs which initialize data](#Always-default-to-constructs-which-initialize-data)[](#Always-default-to-constructs-which-initialize-data "Permalink")
...
### [Use extra precaution when running external processes](#Use-extra-precaution-when-running-external-processes)[](#Use-extra-precaution-when-running-external-processes "Permalink")
...
### [Avoid eval whenever possible](#Avoid-eval-whenever-possible)[](#Avoid-eval-whenever-possible "Permalink")
...
### [Avoid bounds check removal, and if done, add appropriate manual checks](#Avoid-bounds-check-removal,-and-if-done,-add-appropriate-manual-checks)[](#Avoid-bounds-check-removal,-and-if-done,-add-appropriate-manual-checks "Permalink")
...
### [Avoid ccall unless necessary, and use safe ccall practices when required](#Avoid-ccall-unless-necessary,-and-use-safe-ccall-practices-when-required)[](#Avoid-ccall-unless-necessary,-and-use-safe-ccall-practices-when-required "Permalink")
...
*   Julia provides aliases for C types like Cint, Clong, Cchar, Csize\_t, etc. It makes sure that these match what the C ABI on the machine that code is running on expects them to be.
...
### [Validate all user inputs to avoid code injection](#Validate-all-user-inputs-to-avoid-code-injection)[](#Validate-all-user-inputs-to-avoid-code-injection "Permalink")
...
### [Ensure secure random number generators are used when required](#Ensure-secure-random-number-generators-are-used-when-required)[](#Ensure-secure-random-number-generators-are-used-when-required "Permalink")
...
### [Be aware of distributed computing encryption principles](#Be-aware-of-distributed-computing-encryption-principles)[](#Be-aware-of-distributed-computing-encryption-principles "Permalink")

Julia’s distributed computing uses unencrypted TCP/IP sockets for communication by default and expects to be running on a fully trusted cluster. If `using Distributed` in your code through `@distributed`, `pmap`, etc., be aware that the communication channels are not encrypted. Julia opens ports for communication between processes in a distributed cluster. A pre-generated random cookie is necessary to successfully connect (Julia v0.5 onwards), which defeats arbitrary external connections. This mechanism is described in detail in [https://github.com/JuliaLang/julia/pull/16292](https://github.com/JuliaLang/julia/pull/16292).
...
### [Always immediately flush secret data after handling](#Always-immediately-flush-secret-data-after-handling)[](#Always-immediately-flush-secret-data-after-handling "Permalink")
...
## [Specific Rules](#Specific-Rules)[](#Specific-Rules "Permalink")

### [High Level Rules](#High-Level-Rules)[](#High-Level-Rules "Permalink")

*   Use 4 spaces per indentation level, no tabs.
*   Try to adhere to a 92 character line length limit.

### [General Naming Principles](#General-Naming-Principles)[](#General-Naming-Principles "Permalink")
...
### [Comments](#Comments)[](#Comments "Permalink")
...
### [Modules](#Modules)[](#Modules "Permalink")
...
*   Exported variables should be considered part of the public API, and changing their interface constitutes a breaking change.
...
*   A file that includes the definition of a module, should not include any other code that runs outside that module. i.e. the module should be declared at the top of the file with the `module` keyword and `end` at the bottom of the file. No other code before, or after (except for module docstring before). In this case, the code within the module block should **not** be indented.
    
*   Sometimes, e.g. for tests, or for namespacing an enumeration, it _is_ desirable to declare a submodule midway through a file. In this case, the code within the submodule **should** be indented.
    

### [Functions](#Functions)[](#Functions "Permalink")
...
### [Function Argument Precedence](#Function-Argument-Precedence)[](#Function-Argument-Precedence "Permalink")
...
### [Tests and Continuous Integration](#Tests-and-Continuous-Integration)[](#Tests-and-Continuous-Integration "Permalink")
...
*   [Doctests](https://documenter.juliadocs.org/stable/man/doctests/) should be enabled except for the examples that are computationally-prohibitive to have as part of continuous integration.
    

### [Whitespace](#Whitespace)[](#Whitespace "Permalink")
...
### [NamedTuples](#NamedTuples)[](#NamedTuples "Permalink")
...
### [Numbers](#Numbers)[](#Numbers "Permalink")
...
### [Ternary Operator](#Ternary-Operator)[](#Ternary-Operator "Permalink")
...
### [For loops](#For-loops)[](#For-loops "Permalink")
...
### [Function Type Annotations](#Function-Type-Annotations)[](#Function-Type-Annotations "Permalink")
...
### [Struct Type Annotations](#Struct-Type-Annotations)[](#Struct-Type-Annotations "Permalink")
...
### [Macros](#Macros)[](#Macros "Permalink")
...
### [Types and Type Annotations](#Types-and-Type-Annotations)[](#Types-and-Type-Annotations "Permalink")
...
### [Package version specifications](#Package-version-specifications)[](#Package-version-specifications "Permalink")
...
### [Documentation](#Documentation)[](#Documentation "Permalink")
...
### [Error Handling](#Error-Handling)[](#Error-Handling "Permalink")
...
### [Arrays](#Arrays)[](#Arrays "Permalink")

*   Avoid splatting (`...`) whenever possible. Prefer iterators such as `collect`, `vcat`, `hcat`, etc. instead.

### [Line Endings](#Line-Endings)[](#Line-Endings "Permalink")

Always use Unix style `\n` line ending.

### [VS-Code Settings](#VS-Code-Settings)[](#VS-Code-Settings "Permalink")
...
### [JuliaFormatter](#JuliaFormatter)[](#JuliaFormatter "Permalink")
...
## [References](#References)[](#References "Permalink")

Many of these style choices were derived from the [Julia style guide](https://docs.julialang.org/en/v1/manual/style-guide/), the [YASGuide](https://github.com/jrevels/YASGuide), and the [Blue style guide](https://github.com/JuliaDiff/BlueStyle).
...
This document was generated with [Documenter.jl](https://github.com/JuliaDocs/Documenter.jl) version 1.15.0 on Saturday 8 November 2025. Using Julia version 1.12.1.