...
\item \textbf{Look something up} — the Specifics section: formats, projection specs, the operation catalog, and the one-page \href{cheatsheet.md}{Cheat Sheet}.
...
\begin{minted}{text}
          finite set             value = code point       project once
   ┌──────────────────────┐   name   ┌──────────┐   exact    ┌────────────┐
   │  finite set of       │  ⇄       │  value = │   math     │  project   │
   │  datums (code points)│─────────→│ code pt. │───────────→│  once      │
   └──────────────────────┘  decode  └──────────┘            └────────────┘
                                                                  │
                    projection choices          exactness        ▼
...
\section{Arrays, Blocks \& Packed Storage}
...
\section{Conformance \& Approximation Registry}
...
\section{Watch RoundToPrecision work}



\label{7285362548043127585}{}
...
\section{Symbolic sticky projecting}



\label{13272694550445455563}{}
...
\section{Tables are scalar function paths}



\label{224285728400918145}{}
...
Ordering is integer arithmetic: a sign-magnitude fold, monotone with the total order, NaN at the bottom. This is what comparisons and the O(n) counting sort run on:
...
\href{howto\_\allowbreak{}choose\_\allowbreak{}format.md}{How-Tos}, \href{under\_\allowbreak{}architecture.md}{Architecture Overview}, \href{cheatsheet.md}{Cheat Sheet}.
