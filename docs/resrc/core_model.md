...
*Now you can read:* [Formats, Aliases & Representations](concept_format_anatomy.md) for why
...
*Now you can read:* [Values, Code Points & Conversion](concept_values_codepoints.md) for the
...
*Now you can read:* [The Projection Contract](concept_exact_then_project.md) for what "exact"
...
*Now you can read:* [Projection: Rounding & Saturation](concept_rounding_saturation.md) for the
...
*Now you can read:* [Register & Measure an Approximation](workflow_approximation.md), and
[Conformance & Approximation Registry](reference_conformance.md).
