...
[The Encoding & Projection Engine](internals_encoding_decoding.md),
[The Oracle & Rigor Classes](internals_oracle.md),
[Tables, Kernels & Sorting](internals_tables.md),
[Blocks: Exactness without Superaccumulators](internals_blocks.md),
