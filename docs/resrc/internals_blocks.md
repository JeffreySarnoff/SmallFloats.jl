...
- [Blocks & Scaled Operations](reference_arrays_blocks_storage.md) — the API.
- [Working with Blocks](workflow_blocks.md) — the tutorial.
- [Blocks for Dynamic Range](workflow_blocks.md) — when to reach
  for one.
- [The Oracle & Rigor Classes](internals_oracle.md) — where the enclosure cascade
  comes from.
