...
This tutorial assumes the First Session: you've seen `Binary8p4se(1.6)` project onto
...
[Projection: Rounding & Saturation](concept_rounding_saturation.md),
[Format Names & Queries](reference_formats_values.md).
