...
format-query accessor. For narrative explanation, see the Core Model page;
for a worked introduction, see the First Session and Values, Code Points &
Conversion.
...
[Values, Code Points & Conversion](concept_values_codepoints.md),
