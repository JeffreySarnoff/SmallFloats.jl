...
**P3109 Draft Notes** — [docs/other/IEEE_D1_concepts.md](docs/other/IEEE_D1_concepts.md).
...
[docs/other/IEEE_D1.md](docs/other/IEEE_D1.md) in the repository.

## Design Rationales

**dyadic_rational.md** — [docs/other/dyadic_rational.md](docs/other/dyadic_rational.md).
...
**promoterules.md** — [docs/other/promoterules.md](docs/other/promoterules.md).
...
**Float32inside.md** — [docs/other/Float32inside.md](docs/other/Float32inside.md).
...
**Float32more.md** — [docs/other/Float32more.md](docs/other/Float32more.md).
...
**extendingK.md** — [docs/other/extendingK.md](docs/other/extendingK.md).
...
**doingtheextensions.md** — [docs/other/doingtheextensions.md](docs/other/doingtheextensions.md).
...
**implementextensions.md** — [docs/other/implementextensions.md](docs/other/implementextensions.md).
...
**morejulian.md** — [docs/other/morejulian.md](docs/other/morejulian.md).
