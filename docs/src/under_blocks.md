...
- [Blocks & Scaled Operations](ref_arrays_blocks.md) — the API.
- [Working with Blocks](tutorial4_blocks.md) — the tutorial.
- [Blocks for Dynamic Range](howto_blocks_dynamic_range.md) — when to reach
  for one.
- [The Oracle & Rigor Classes](under_oracle.md) — where the enclosure cascade
  comes from.
- [Proving your fused kernel exact](examples_internals.md#Proving-your-fused-kernel-exact:-BlockDotProduct-vs-512-bit-truth)
  — `BlockDotProduct` against 512-bit truth.
- [Add an Operation](howto_add_operation.md) — adding block variants.
