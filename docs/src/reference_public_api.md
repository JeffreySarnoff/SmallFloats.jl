...
| Session state | numerical defaults, Julia/explicit RNG use, display styles, and default-consumption combinators | [Defaults, Randomness, and Display](reference_defaults_random_display.md) |
